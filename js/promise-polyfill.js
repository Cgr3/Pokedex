...
!(function(e, t) {
	...
	r.prototype['catch'] = function(e) {
		...
		return i(
			this,
			new (function(e, t, n) {
				this.onFulfilled = 'function' == typeof e ? e : null, this.onRejected = 'function' == typeof t
					? t
					: null, this.promise = n;
			})(e, t, n)
		), n;
	...
	}, r._immediateFn = 'function' == typeof setImmediate &&
		function(e) {
			setImmediate(e);
		} ||
		function(e) {
	...
	'function' != typeof s.Promise
		? s.Promise = r
		: (s.Promise.prototype['finally'] || (s.Promise.prototype['finally'] = e), s.Promise.allSettled ||
				(s.Promise.allSettled = t));
});
/* eslint-enable */
